...
public class StackArray {
    ...
    public static void push(int[] stack,int elemnent){
        if(top==stack.length){
            System.out.println("LinearDataStructure.Stack is full");
            return;
        }
        stack[top] = elemnent;
        top++;
    ...
    public static void pop(int[] stack){
        if(top==0){
            System.out.println("LinearDataStructure.Stack is Empty");
            return;
        }
        stack[top] = 0;
        top--;
    ...
    public static void print(int[] stack){
        System.out.print("LinearDataStructure.Stack is: ");
        for (int i=0;i<top;i++){
